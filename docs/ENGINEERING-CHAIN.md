...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Service contracts, health/readiness and deployment boundaries and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_cloud.py](../tests/test_cloud.py) | Contract-focused validation at the repository boundary |
