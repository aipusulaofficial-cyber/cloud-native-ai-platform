...
## Core boundary
**Primary concern:** Cloud-native services.

Keep service contracts independent of deployment infrastructure; make health/readiness explicit; bound resources; isolate infrastructure adapters; treat deployment safety and rollback as operational concerns.
